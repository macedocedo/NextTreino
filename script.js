// Base de dados de exercícios com imagens reais
const exerciseDatabase = {
    ...
    "triceps": [
        ...
        {
            id: "Supino fechado com halteres",
...
function finishSavingWorkout(workoutName) {
    ...
    try {
        ...
        navigateToPage('page-train'); // CORREÇÃO AQUI: 'page-train' em vez de 'page_train'
...
function completeExercise() {
    ...
    if (!isFavorite) {
        ...
        localStorage.setItem('NextTreinoappFavorites', JSON.stringify(favoriteExercises));
    }
